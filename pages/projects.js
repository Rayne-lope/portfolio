...
const projectsData = [
  // --- PROJECT BARU: AERO ---
  {
    ...
    thumbnail: "../projects/Aero/AERO.png",
    images: [
      "../projects/Aero/AERO.png", // Paling atas sesuai request
      "../projects/Aero/1.png",
      "../projects/Aero/2.png",
      "../projects/Aero/3.png",
      "../projects/Aero/4.png",
    ...
    link: "", // Kosongkan karena hanya desain
    figma:
  ...
  },
  {
    ...
    thumbnail: "../projects/planify/1.jpeg",
    images: [
  ...
  },
  {
    ...
    thumbnail: "../projects/tripsaver/1.jpeg",
    images: [
  ...
  },
  {
    ...
    thumbnail: "../projects/pengaduan/1.jpeg",
    images: [
  ...
  },
  {
    ...
    thumbnail: "../projects/djawa/1.jpeg",
    images: [
  ...
  },
  {
    ...
    thumbnail: "../projects/parfum/1.jpeg",
    images: [
  ...
  },
  {
    ...
    thumbnail: "../projects/topup/1.jpeg",
    images: [
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (detailTitle) {
    ...
    if (project) {
      ...
      // RENDER TOMBOL LINK (Smart Logic)
      const linksContainer = document.getElementById("detail-links");
      if (linksContainer) {
        linksContainer.innerHTML = "";

        // HANYA tampilkan tombol Source jika linknya ada dan bukan "#" atau kosong
        ...
        // Tampilkan tombol Figma jika ada
        if (project.figma) {
          ...
          // Jika tidak ada source code, tombol figma jadi warna putih (primary) biar cakep
          if (!project.link || project.link === "" || project.link === "#") {
            figmaLink.className =
              "w-full bg-white text-black py-3 rounded-xl flex items-center justify-center gap-2 font-bold hover:bg-gray-200 transition-colors";
          }
